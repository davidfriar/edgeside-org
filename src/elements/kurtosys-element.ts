...
export class KurtosysElementHandler extends RESTElementHandler {
	...
	fetchData(): Promise<Response> {
		...
		return fetch(url, {
			...
			body: '{"type":"CLSS","search":[{"property":"isin","values":["' + this.isin + '"],"matchtype":"MATCH"}],"include":{"timeseries":{},"disclaimers":{}},"culture":"en-GB","applyFormats":false,"start":0,"limit":1,"fundList":"view_uk_pri_OEIC","sort":{"key":"infinite_sort","direction":"ASC"}}',
